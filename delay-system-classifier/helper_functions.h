...
void initialize_weights(arma::mat &input_weights, arma::cube &hidden_weights, arma::mat &output_weights, int D, int L, int N, std::vector<int> diag_indices, double initial_input_weigt_radius, double initial_hidden_weigt_radius, double initial_output_weigt_radius, bool save_to_file, bool no_input_layer);
