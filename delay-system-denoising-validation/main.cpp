		...
		for (int epoch = 0; epoch < number_of_epochs; ++epoch){
			...
			for (int index = 0; index < training_batch_size; ++index){
				...
				if (index < save_examples){
					string original_file_name = "example_results/valbatch_" + to_string(validation_batch_index + 1) + "_epoch_" + to_string(epoch + 1) + "_example_" + to_string(index + 1) + "_original.txt";
					string input_file_name = "example_results/valbatch_" + to_string(validation_batch_index + 1) + "_epoch_" + to_string(epoch + 1) + "_example_" + to_string(index + 1) + "_input.txt";
					string output_file_name = "example_results/valbatch_" + to_string(validation_batch_index + 1) + "_epoch_" + to_string(epoch + 1) + "_example_" + to_string(index + 1) + "_output.txt";
